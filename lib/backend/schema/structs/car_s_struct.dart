...
class CarSStruct extends BaseStruct {
  CarSStruct({
    int? id,
    String? name,
    int? brand,
  ...
  static CarSStruct fromMap(Map<String, dynamic> data) => CarSStruct(
  ...
  static CarSStruct? maybeFromMap(dynamic data) =>
      data is Map ? CarSStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static CarSStruct fromSerializableMap(Map<String, dynamic> data) =>
      CarSStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'CarSStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is CarSStruct &&
        id == other.id &&
        name == other.name &&
        brand == other.brand &&
        rent == other.rent &&
